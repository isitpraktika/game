...
Window {
    ...
    property int rand: 0
    property int bgSpeed: 5
    property bool volume: true
    property int accelerate: 0
    signal boom()
    signal bonusSignal()
    ...
    Audio {
        id: playSound
        source: "assets/Music/8_BITNAYA_MUZYKA_-_..._(iPlayer.fm).wav"
        volume: 100
    }
    Background {
        id: bg
    ...
    Button{
        ...
        MouseArea{
            ...
            onClicked: {
                if(volume === true){
                    playSound.stop()
                    volumeButton.buttonText = "ON"
                    volume = false
                }
                if(volume === false) {

                    playSound.play()
                    volumeButton.buttonText = "OFF"
                    volume = true
                }
            }
        }
